            ...
            if (braceCount === 0) {
                ...
                if (hasName) {
                    ...
                    if (spaceIndex < 0) {
                        ...
                        // has a space
                        name_1 = rest.slice(0, spaceIndex);
                ...
                if (name_1) {
                    if (name_1.charAt(0) === '[') {
                        ...
                        name_1 = name_1.slice(1, name_1.length - 1);
                    }
                    result.name = name_1;
                }
                if (description) {
...
function extractDocumentation(program) {
                            ...
                            if (i + 1 < instanceProperties.length) {
                                ...
                                if (nextExpression.type === 'FunctionExpression') {
                                    ...
                                    if (nextProperty.kind === 'get' &&
                                        ("get".concat(capitalizedNextName) === key) ||
                                        ("is".concat(capitalizedNextName) === key)) {
                                        ...
                                        "set".concat(capitalizedNextName) === key) {
    ...
    var _loop_1 = function (i) {
        ...
        // Variable object initialization: e.g. var Utils = { ... };
            ...
            var objectName_1 = topLevelStatement.declarations[0].id.name;
            doc[objectName_1] = {
            ...
            topLevelStatement.declarations[0].init.properties.forEach(function (property) {
                var staticDoc = parseStaticProperty(property);
                if (staticDoc) {
                    doc[objectName_1].properties.push(staticDoc);
                }
            });
        }
    };
