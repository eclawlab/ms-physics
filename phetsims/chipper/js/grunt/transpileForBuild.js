...
exports.default = transpileForBuild;
/**
 ...
 */
// modules
var babel = require('@babel/core'); // eslint-disable-line phet/require-statement-match
/**
 ...
 */
function transpileForBuild(jsInput, supportInternetExplorer) {
    if (supportInternetExplorer === void 0) { supportInternetExplorer = false; }
