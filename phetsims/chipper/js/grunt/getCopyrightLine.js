...
exports.default = (function (repo, relativeFile) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, execute_js_1.default)('git', [
                    'log', '--diff-filter=A', '--follow', '--date=short', '--format=%cd', '-1', '--', relativeFile
                ], "../".concat(repo))];
            case 1:
                startDate = (_a.sent()).trim().split('-')[0];
                return [4 /*yield*/, (0, execute_js_1.default)('git', [
                        'log', '--follow', '--date=short', '--format=%cd', '-1', '--', relativeFile
                    ], "../".concat(repo))];
            case 2:
                endDate = (_a.sent()).trim().split('-')[0];
                dateString = '';
                ...
                if (startDate === '' && endDate === '') {
                    ...
                    dateString = (startDate === endDate) ? startDate : ("".concat(startDate, "-").concat(endDate));
                }
                return [2 /*return*/, "// Copyright ".concat(dateString, ", University of Colorado Boulder")];
        }
    });
}); });
