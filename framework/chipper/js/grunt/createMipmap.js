 ...
 */
var fs_1 = require("fs");
var mipmapDownscale_js_1 = require("../../../chipper/js/common/mipmapDownscale.js");
var grunt_js_1 = require("../../../perennial-alias/js/npm-dependencies/grunt.js");
var jpegJs = require('jpeg-js');
var pngjs = require('pngjs');
function createMipmap(filename, maxLevel, quality) {
    return new Promise(function (resolve, reject) {
        ...
        function loadJPEG() {
            var imageData = jpegJs.decode(fs_1.default.readFileSync(filename));
            mipmaps.push({
                data: imageData.data,
        ...
        function loadPNG() {
            var src = fs_1.default.createReadStream(filename);
        ...
        function outputJPEG(data, width, height, quality, callback) {
            var encodedOuput = jpegJs.encode({
                data: data,
                width: width,
                height: height
            }, quality);
        ...
        function startMipmapCreation() {
            ...
            function encodingComplete() {
                grunt_js_1.default.log.verbose.writeln("mipmapped ".concat(filename).concat(maxLevel >= 0 ? " to level ".concat(maxLevel) : '', " with quality: ").concat(quality));
                for (var level = 0; level < mipmaps.length; level++) {
                    ...
                    grunt_js_1.default.log.verbose.writeln("level ".concat(level, " (").concat(usePNG ? 'PNG' : 'JPG', " ").concat(mipmaps[level].width, "x").concat(mipmaps[level].height, ") base64: ").concat(mipmaps[level].url.length, " bytes "));
                }
                resolve(mipmaps);
            }
            ...
            while ((mipmaps.length - 1 < maxLevel || maxLevel < 0) && (finestMipmap().width > 1 || finestMipmap().height > 1)) {
                ...
                mipmaps.push((0, mipmapDownscale_js_1.default)(finestMipmap(), function (width, height) {
