 ...
 */
var fs_1 = require("fs");
var getCopyrightLine_js_1 = require("./getCopyrightLine.js");
/**
 ...
 */
exports.default = (function (repo, relativeFile) { return __awaiter(void 0, void 0, void 0, function () {
    var fileContents, firstLine;
    return __generator(this, function (_a) {
        if (fs_1.default.existsSync("../".concat(repo, "/").concat(relativeFile))) {
            fileContents = fs_1.default.readFileSync("../".concat(repo, "/").concat(relativeFile), 'utf8');
            if (fileContents.startsWith('// Copyright ')) {
                firstLine = fileContents.split('\n')[0];
                return [2 /*return*/, firstLine.trim()];
            }
        }
        return [2 /*return*/, (0, getCopyrightLine_js_1.default)(repo, relativeFile)];
    });
}); });
