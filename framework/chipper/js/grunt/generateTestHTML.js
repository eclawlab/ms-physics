...
var generateDevelopmentHTML_js_1 = require("./generateDevelopmentHTML.js");
exports.default = (function (repo, options) { return __awaiter(void 0, void 0, void 0, function () {
    var isChipper;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                isChipper = repo === 'chipper';
                return [4 /*yield*/, (0, generateDevelopmentHTML_js_1.default)(repo, lodash_1.default.merge({
                        // Include QUnit CSS
                        ...
                        outputFile: "".concat(repo, "-tests.html"),
                        // Add the QUnit divs (and Scenery display div if relevant)
                        bodystart: "<div id=\"qunit\"></div>\n<div id=\"qunit-fixture\"></div>".concat(repo === 'scenery' ? '<div id="display"></div>' : ''),
                        // Add QUnit JS
                        ...
                        mainFile: "../chipper/dist/js/".concat(repo, "/js/").concat(isChipper ? 'browser/' : '').concat(repo, "-tests.js"),
