...
qunit_js_1.default.module('phetioCompareAPIs');
var _phetioCompareAPIs = function (referenceAPI, proposedAPI, options) {
    return (0, phetioCompareAPIs_js_1.default)(referenceAPI, proposedAPI, lodash_1.default, options);
};
...
qunit_js_1.default.test('basics', function (assert) {
    var referenceAPI = lodash_1.default.merge({
        phetioElements: {
            phetioEngine: {
                _metadata: {
    ...
    var proposedAPI = lodash_1.default.cloneDeep(referenceAPI);
    var report = _phetioCompareAPIs(referenceAPI, proposedAPI);
...
qunit_js_1.default.test('designed changes', function (assert) {
    var referenceAPI = lodash_1.default.merge({
        phetioElements: {
            designedElement: {
                _metadata: {
...
qunit_js_1.default.test('breaking element API changes', function (assert) {
    var referenceAPI = lodash_1.default.merge({
        phetioElements: {
            breakingElement: {
                _metadata: {
    ...
    var testMetadataKeyChange = function (metadataKey, valueThatBreaksAPI) {
        proposedAPI = lodash_1.default.cloneDeep(referenceAPI);
        // @ts-expect-error
    ...
    metadataBreakingData.forEach(function (testData) {
        var test = function () { return testMetadataKeyChange(testData.metadataKey, testData.value); };
        if (testData.assert) {
...
qunit_js_1.default.test('testing PhetioTypes', function (assert) {
    var referenceAPI = {
    ...
    var propertyIOEntry = proposedAPI.phetioTypes['PropertyIO<Vector2IO>'];
