...
var KEY_CONTROL_LEFT = 'ControlLeft';
var KEY_CONTROL_RIGHT = 'ControlRight';
var KEY_ALT_LEFT = 'AltLeft';
var KEY_ALT_RIGHT = 'AltRight';
var KEY_META_LEFT = 'MetaLeft';
var KEY_META_RIGHT = 'MetaRight';
var KEY_META_LEFT_FIREFOX = 'OSLeft'; // FF specific codes for meta keys
var KEY_META_RIGHT_FIREFOX = 'OSRight';
var KEY_W = 'KeyW';
var KEY_A = 'KeyA';
var KEY_S = 'KeyS';
var KEY_D = 'KeyD';
...
var ARROW_KEYS = [KEY_RIGHT_ARROW, KEY_LEFT_ARROW, KEY_UP_ARROW, KEY_DOWN_ARROW];
var WASD_KEYS = [KEY_W, KEY_S, KEY_A, KEY_D];
var NUMBER_KEYS = [KEY_0, KEY_1, KEY_2, KEY_3, KEY_4, KEY_5, KEY_6, KEY_7, KEY_8, KEY_9];
var SHIFT_KEYS = [KEY_SHIFT_LEFT, KEY_SHIFT_RIGHT];
var CONTROL_KEYS = [KEY_CONTROL_LEFT, KEY_CONTROL_RIGHT];
var ALT_KEYS = [KEY_ALT_LEFT, KEY_ALT_RIGHT];
var META_KEYS = [KEY_META_LEFT, KEY_META_RIGHT, KEY_META_LEFT_FIREFOX, KEY_META_RIGHT_FIREFOX];
// These are KeyboardEvent.key values, excluding left/right KeyboardEvent.codes
var MODIFIER_KEYS = [KEY_ALT, KEY_CONTROL, KEY_SHIFT];
// These are KeyboardEvent.code values for modifier keys
var MODIFIER_KEY_CODES = [KEY_ALT_LEFT, KEY_ALT_RIGHT, KEY_CONTROL_LEFT, KEY_CONTROL_RIGHT, KEY_SHIFT_LEFT, KEY_SHIFT_RIGHT, KEY_META_LEFT, KEY_META_RIGHT, KEY_META_LEFT_FIREFOX, KEY_META_RIGHT_FIREFOX];
var DOM_EVENT_VALIDATOR = { valueType: Event };
var ALL_KEY_CODES = [];
/**
 * @extends {Object}
...
var KeyboardUtils = {
     ...
     */
    getNumberFromCode: function (domEvent) {
     ...
     */
    isControlKey: function (domEvent) {
     ...
     */
    isMovementKey: function (domEvent) {
     ...
     */
    isAnyKeyEvent: function (domEvent, keyboardUtilsKeys) {
        (0, validate_js_1.default)(domEvent, DOM_EVENT_VALIDATOR);
        var code = KeyboardUtils.getEventCode(domEvent);
        return code ? keyboardUtilsKeys.includes(code) : false;
    },
    /**
     * Whether the event was of the provided KeyboardUtils string.
     */
    isKeyEvent: function (domEvent, keyboardUtilsKey) {
     ...
     */
    getEventCode: function (domEvent) {
        var eventCode = null;
...
for (var keyKey in KeyboardUtils) {
...
scenery_js_1.default.register('KeyboardUtils', KeyboardUtils);
