...
exports.PoissonEventModel = exports.UniformEventModel = exports.ConstantEventModel = void 0;
/**
...
var EventTimer = /** @class */ (function () {
     ...
     */
    EventTimer.prototype.step = function (dt) {
     ...
     */
    EventTimer.prototype.getRatio = function () {
        return (this.period - this.timeBeforeNextEvent) / this.period;
    };
    return EventTimer;
}());
exports.default = EventTimer;
var ConstantEventModel = /** @class */ (function () {
    /*
     * Event model that will fire events at a constant rate. An event will occur every 1/rate time units.
     */
    function ConstantEventModel(rate) {
        this.rate = rate;
        (0, affirm_js_1.default)(rate > 0, 'We need to have a strictly positive rate in order to prevent infinite loops.');
    }
    ConstantEventModel.prototype.getPeriodBeforeNextEvent = function () {
        return 1 / this.rate;
    };
    return ConstantEventModel;
}());
exports.ConstantEventModel = ConstantEventModel;
var UniformEventModel = /** @class */ (function () {
    /*
     ...
     */
    function UniformEventModel(rate, pseudoRandomNumberSource) {
        this.rate = rate;
        this.pseudoRandomNumberSource = pseudoRandomNumberSource;
        (0, affirm_js_1.default)(rate > 0, 'We need to have a strictly positive rate in order to prevent infinite loops.');
    }
    UniformEventModel.prototype.getPeriodBeforeNextEvent = function () {
        var uniformRandomNumber = this.pseudoRandomNumberSource();
        (0, affirm_js_1.default)(uniformRandomNumber >= 0 && uniformRandomNumber < 1, "Our uniform random number is outside of its expected range with a value of ".concat(uniformRandomNumber));
        // sample the exponential distribution
        return uniformRandomNumber * 2 / this.rate;
    };
    return UniformEventModel;
}());
exports.UniformEventModel = UniformEventModel;
var PoissonEventModel = /** @class */ (function () {
    /*
     * Event model that will fire events corresponding to a Poisson process with the specified rate.
     * The pseudoRandomNumberSource, when called, should generate uniformly distributed random numbers in the range [0,1).
     */
    function PoissonEventModel(rate, pseudoRandomNumberSource) {
        this.rate = rate;
        this.pseudoRandomNumberSource = pseudoRandomNumberSource;
        (0, affirm_js_1.default)(rate > 0, 'We need to have a strictly positive poisson rate in order to prevent infinite loops.');
    }
    PoissonEventModel.prototype.getPeriodBeforeNextEvent = function () {
    ...
    return PoissonEventModel;
}());
exports.PoissonEventModel = PoissonEventModel;
phetCore_js_1.default.register('PoissonEventModel', PoissonEventModel);
phetCore_js_1.default.register('UniformEventModel', UniformEventModel);
phetCore_js_1.default.register('ConstantEventModel', ConstantEventModel);
phetCore_js_1.default.register('EventTimer', EventTimer);
